...
def build_deals_pipeline_group(configurator):
	...
	_add_exec_task(job, 'bundle exec rake cf:cups[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'pricing_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'pricing_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'deals_build')
...
def build_web_app_pipeline_group(configurator):
	...
	_add_exec_task(job, 'bundle exec rake cf:cups[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'catalog_build')
	_add_exec_task(job, 'bundle exec rake cf:cups[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'pricing_build')
	_add_exec_task(job, 'bundle exec rake cf:cups[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'deals_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'catalog_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'pricing_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'deals_build')
	_add_exec_task(job, 'bundle exec rake cf:deploy[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'web_app_build')
	...
	_add_exec_task(job, 'bundle exec rake cf:delete[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'web_app_build', "any")
	_add_exec_task(job, 'bundle exec rake cf:delete[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'deals_build', "any")
	_add_exec_task(job, 'bundle exec rake cf:delete[test,$GO_PIPELINE_NAME$GO_PIPELINE_COUNTER]', 'pricing_build', "any")
