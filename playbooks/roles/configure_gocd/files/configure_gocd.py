...
def build_catalog_pipeline_group(configurator):
	...
	pipeline = _create_pipeline("catalog", "catalog_deploy_production", True)
...
def build_pricing_pipeline_group(configurator):
	...
	pipeline = _create_pipeline("pricing", "pricing_deploy_production", True)
...
def build_deals_pipeline_group(configurator):
	...
	pipeline = _create_pipeline("deals", "deals_deploy_production", True)
...
def build_web_app_pipeline_group(configurator):
	...
	job.ensure_artifacts(set([BuildArtifact("web_app_build/*", "web_app_build"), TestArtifact("web_app_build/spec/reports")]))

	pipeline = _create_pipeline("web_app", "web_app_deploy_production", True)
